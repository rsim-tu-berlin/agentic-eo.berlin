...
<p>
  From EO services to tools and use cases: a one-day hackathon on agentic Earth Observation for
  scientists, AI practitioners, and software engineers. The day centres on
  ...
  tools. Participants wrap EO services as agent-callable tools, compose them in agentic workflows,
...
<p>The hackathon primarily targets:</p>
...
<p>
  Join on your own or in a team of 1–4. Team formation is part of the day: pick a use case together
  and plan what you aim to build during the sprint. Teams form at the event; you build your MCP
  server during the sprint. Mixed backgrounds are welcome and encouraged.
</p>
...
<p>Proposed flow for the day (~7 h one-day sprint), starting at 9 am.</p>
...
<div class="table-responsive">
  <table class="table table-striped align-middle">
    ...
    <tbody>
      <tr>
        <th scope="row" class="fw-normal">Kickoff &amp; primer</th>
        <td class="text-nowrap">30–45 min</td>
      ...
      <tr>
        <th scope="row" class="fw-normal">Team formation &amp; scoping</th>
        <td class="text-nowrap">30 min</td>
        <td>Teams of 1–4 form, decide a use case</td>
      </tr>
      <tr>
        <th scope="row" class="fw-normal">Build sprint</th>
        <td class="text-nowrap">~4 h</td>
        <td>Build MCP servers, test with the agent, iterate; mentors circulate</td>
      </tr>
      <tr>
        <th scope="row" class="fw-normal">Submission</th>
        <td class="text-nowrap">30 min</td>
        <td>Teams deliver their submission</td>
      </tr>
      <tr>
        <th scope="row" class="fw-normal">Demos &amp; cross-platform showcase</th>
        <td class="text-nowrap">45–60 min</td>
...
<p>
  ...
  <a href="https://philab.esa.int/" target="_blank" rel="noopener">ESA Φ-lab Challenges Programme</a>.
  Every participating team must designate a team leader who acts as main point of contact. All prize
  money and reimbursements will be transferred to the point of contact of the respective team. The
  point of contact and the teams are responsible for fair and equal distribution of the prize money
...
<p>
  Registration and application details will be published shortly.
</p>
