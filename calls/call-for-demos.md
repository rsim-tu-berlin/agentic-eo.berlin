...
<p>
  The workshop will feature a dedicated Demo Session to showcase innovative tools, prototypes, and live research applications. We invite submissions from both academia and industry that provide an interactive experience for attendees.
  <br />
  If you would like to present a demo, please submit a proposal of no more than two pages. Proposals will be reviewed by the Organization Committee based on technical quality, relevance to the workshop themes, and the interactive nature of the presentation.
</p>
